#!/usr/bin/env python3
"""Run every Track Manager suite inside the already-running REAPER.
...
The panel suite is not here -- it has to be deferred, so it needs
tools/run_panel_test.py. Exits non-zero if any suite fails.
"""
...
SUITES = [
    ...
    ("verify", "test/verify_in_reaper.lua", 180),
]
